...
pub struct Parsers {
    ...
    parents: BTreeMap<u32, BTreeSet<Option<u32>>>, // the root can BE a parent, but will not HAVE a parent
    children: BTreeMap<Option<u32>, BTreeSet<u32>>, // the root can HAVE children, but will not BE a child
}
